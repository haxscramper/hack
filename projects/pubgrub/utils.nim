...
proc toSentence*[T](iter: seq[T], conjunction: string = "and"): string =
  ## Returns a sentence fragment listing the elements of [iter].
  ##
  ## This converts each element of [iter] to a string and separates them
  ## with commas and/or [conjunction] (`"and"` by default) where
  ## appropriate.
  ...
  if (iter.len == 1):
    ...
    return iter[0 ..^ 2].mapIt($it).join(", ") & " {conjunction} {iter[^1]}"
