...
function evalTable() {
    ...
    var start_x = parseFloat(document.getElementById('input_x_start').value);
    var final_x = parseFloat(document.getElementById('input_x_final').value);
...

    {
        ...
        tr.appendChild(newCell("x"));
        tr.appendChild(newCell("y"));

        table.appendChild(tr);
}

    for(var current_x = start_x; current_x <= final_x; current_x += x_step) {
        var tr = document.createElement("tr");
