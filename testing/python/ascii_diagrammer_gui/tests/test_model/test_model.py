...
class TestModelStructure:
    ...
    def test_insert_at_specific_row(self, empty_model: SceneModel):
    ...
    def test_absolute_coord_accumulation(self, empty_model: SceneModel):
    ...
    def test_reparent_via_moveRows(self, empty_model: SceneModel):
    ...
    def test_reparent_prevent_ancestor_cycle(self, empty_model: SceneModel):
        p_idx = empty_model.insert_item(ShapeType.RECTANGLE)
        c_idx = empty_model.insert_item(ShapeType.ELLIPSE, p_idx)
    ...
    def test_geometry_change_signals(self, empty_model: SceneModel):
        signals_received = []
        ...
        empty_model.setData(idx, item.properties,
                            Qt.ItemDataRole.UserRole + 101)
    ...
    def test_display_name(self, empty_model: SceneModel):
...
class TestSerialization:
    ...
    def test_json_preserves_properties(self, empty_model: SceneModel):
        from ascii_diagram.io.scene_io import (
            model_to_json,
            json_to_model,
        )
