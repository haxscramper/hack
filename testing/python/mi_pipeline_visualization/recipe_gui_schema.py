...
mi_fixed_machines_list = [
    MachineData(english_name="Assembler",
                machine="assembler",
                ...
                progress_bar=ProgressBarParameters(x=105,
                                                   y=45,
                                                   texture="circuit"),
                ...
                item_slots=ItemSlots(positions=[
                    SlotPosition(x=42, y=27, cols=3, rows=3),
                    SlotPosition(x=139, y=27, cols=1, rows=3)
                ]),
                fluid_slots=FluidSlots(
                    positions=[SlotPosition(x=98, y=27, cols=2, rows=1)]),
                front_overlay=True,
                top_overlay=True,
                side_overlay=False,
                tiers=16,
                io_bucket_capacity=16),
    MachineData(english_name="Centrifuge",
                machine="centrifuge",
                ...
                gui_params=GuiParameters(),
                progress_bar=ProgressBarParameters(x=65,
                                                   y=33,
                                                   texture="centrifuge"),
    ...
    MachineData(english_name="Compressor",
                ...
                fluid_output_count=0,
                gui_params=GuiParameters(),
                progress_bar=ProgressBarParameters(x=77,
                                                   y=34,
                                                   texture="compress"),
                ...
                tiers=23,
                io_bucket_capacity=16),
    MachineData(english_name="Cutting Machine",
                ...
                fluid_output_count=0,
                gui_params=GuiParameters(),
                progress_bar=ProgressBarParameters(x=88, y=31,
                                                   texture="slice"),
                efficiency_bar=RecipeEfficiencyBarParameters(x=38, y=62),
                ...
                tiers=23,
                io_bucket_capacity=16),
    MachineData(english_name="Distillery",
                machine="distillery",
                ...
                tiers=16,
                io_bucket_capacity=16),
    MachineData(english_name="Electrolyzer",
                ...
                fluid_output_count=4,
                gui_params=GuiParameters(),
                progress_bar=ProgressBarParameters(x=66, y=35,
                                                   texture="arrow"),
                efficiency_bar=RecipeEfficiencyBarParameters(x=50, y=66),
                energy_bar=EnergyBarParameters(x=10, y=10),
                item_slots=ItemSlots(positions=[
                ...
                tiers=16,
                io_bucket_capacity=16),
    MachineData(english_name="Furnace",
                machine="furnace",
                recipe_type="FURNACE",
                item_input_count=1,
                item_output_count=1,
                ...
                tiers=23,
                io_bucket_capacity=16),
    MachineData(english_name="Macerator",
                machine="macerator",
                ...
                tiers=23,
                io_bucket_capacity=16),
    MachineData(english_name="Mixer",
                machine="mixer",
                recipe_type="MIXER",
                item_input_count=4,
                item_output_count=2,
                ...
                gui_params=GuiParameters(),
                progress_bar=ProgressBarParameters(x=103,
                                                   y=33,
                                                   texture="arrow"),
                efficiency_bar=RecipeEfficiencyBarParameters(x=50, y=66),
                energy_bar=EnergyBarParameters(x=15, y=34),
                ...
                tiers=23,
                io_bucket_capacity=16),
    MachineData(english_name="Packer",
                machine="packer",
                recipe_type="PACKER",
                item_input_count=3,
                item_output_count=1,
                ...
                tiers=20,
                io_bucket_capacity=16),
    MachineData(english_name="Polarizer",
                machine="polarizer",
                ...
                tiers=16,
                io_bucket_capacity=16),
    MachineData(english_name="Wiremill",
                machine="wiremill",
