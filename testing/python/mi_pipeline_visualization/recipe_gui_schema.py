...
mi_fixed_machines_list = [
    MachineData(
        ...
        progress_bar=ProgressBarParameters(x=70, y=60, texture="circuit"),
        efficiency_bar=RecipeEfficiencyBarParameters(x=48, y=96),
        energy_bar=EnergyBarParameters(x=14, y=54),
        item_slots=ItemSlots(positions=[]),
        fluid_slots=FluidSlots(positions=[
            SlotPosition(x=30, y=55, cols=1, rows=1),
            SlotPosition(x=98, y=47, cols=5, rows=2),
        ]),
        front_overlay=True,
        top_overlay=True,
        side_overlay=False,
