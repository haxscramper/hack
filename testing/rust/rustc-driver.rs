...
use rustc_session::config::PpMode::Source;
use rustc_session::config::PpSourceMode::Expanded;
use rustc_span::source_map;
use std::path;
use std::process;
use std::str;

fn treeRepr<'a>(item: &rustc_hir::ItemKind<'_>) -> &'a str {
    match item {
        rustc_hir::ItemKind::Fn(_, _, _) => "T",
        t => "unimplemented"
    }
}
